...
public class phase_view extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phase_view);
        registerDayLabels();
        registerMoonViews();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_phase_view, menu);
        return true;
    }
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        if (itemId == cal.get(Calendar.MONTH)) {
            pickMonth();
    ...
    private class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            View bv=phase_view.this.findViewById(R.id.baseview);
            bv.setX(offset);
            return true;
